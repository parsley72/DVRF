...
#endif
	memcpy(new->cb, old->cb, sizeof(old->cb));
#if defined(CONFIG_NETFILTER_XT_MATCH_LAYER7) || defined(CONFIG_NETFILTER_XT_MATCH_LAYER7_MODULE) //add by Eric:support IPV6
        new->l7_seen = old->l7_seen;
#endif //end by Eric
	new->local_df	= old->local_df;
