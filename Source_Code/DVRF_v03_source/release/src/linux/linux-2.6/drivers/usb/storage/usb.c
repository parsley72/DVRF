...
//Jemmy add to detect storage device 2011.7.29
...
#define USB_SET_LED(cmd)	do {} while(0)
...
static unsigned int plugin_usb_device = 0;
static struct ctl_table_header *usb_sysctl_header;
static ctl_table mytable[] = {
	{
     		//.ctl_name       = CTL_UNNUMBERED,
     		.procname		= "plugin_usb_device",
     		.data			= &plugin_usb_device,
     		.maxlen			= sizeof(plugin_usb_device),
     		.mode			= 0644,
...
static int __init usb_stor_init(void)
{
	...
	//Jemmy add to detect storage device 2011.7.29
	usb_sysctl_header = register_sysctl_table(mytable);                                                                               
