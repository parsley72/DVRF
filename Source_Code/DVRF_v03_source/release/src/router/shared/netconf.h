 ...
 *
 * $Id: netconf.h,v 1.1.1.13 2007/05/31 08:00:30 michael Exp $
 */
...
enum netconf_target {
	...
	NETCONF_UPNPNAT,		/* UPnP port forward (nat) */	//Add 2011-02-23
	NETCONF_TARGET_MAX
};
...
#define netconf_valid_nat(target) \
	((target) == NETCONF_SNAT || (target) == NETCONF_DNAT || (target) == NETCONF_MASQ || (target) == NETCONF_UPNPNAT)	//modified 2011-02-23
...
enum netconf_dir {
	...
	NETCONF_UPNPFWD,		/* UPnP port forward*/	//Add 2011-02-23
	NETCONF_DIR_MAX
};
