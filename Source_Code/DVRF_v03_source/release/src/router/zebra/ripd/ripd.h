...
/* Default interface name size Fixed 05/07/2007*/
#define RIPD_WAN_INTERFACE_SIZE 	20
#define RIPD_WAN_INTERFACE_NUM 		4
#define RIPD_WAN_INTERFACE  		"wan:"
...
struct rip 
{
  ...
  /*Wan Interface name. Fixed 05/07/2007*/
  char wan_name[RIPD_WAN_INTERFACE_SIZE + 1];
...
void rip_get_wan_interface ();
void add_pptp_default_route (char *);
