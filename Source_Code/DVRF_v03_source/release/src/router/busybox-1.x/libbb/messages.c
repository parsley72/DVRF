...
/*John@2010.03.18*/
const char bb_path_passwd_file[] ALIGN1 = "/tmp/passwd";
const char bb_path_shadow_file[] ALIGN1 = "/tmp/shadow";
const char bb_path_group_file[] ALIGN1 = "/tmp/group";
const char bb_path_gshadow_file[] ALIGN1 = "/tmp/gshadow";
const char bb_path_motd_file[] ALIGN1 = "/tmp/motd";
