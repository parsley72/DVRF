...
/* $Id: iscprint.c,v 1.1 2010/09/16 05:37:40 marcel Exp $ */
...
"$Id: iscprint.c,v 1.1 2010/09/16 05:37:40 marcel Exp $ Copyright (c) 2004 Internet Systems Consortium, Inc.  All rights reserved.";
#endif
