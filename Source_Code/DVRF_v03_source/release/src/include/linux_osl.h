 ...
 *
 * $Id: linux_osl.h,v 1.1.1.1 2010/11/24 06:37:38 gavin.ke Exp $
 */
...
extern void osl_pktalloced_dec(osl_t *osh);
extern void osl_pktalloced_inc(osl_t *osh);

#ifdef BCMDBG_PKT
extern void *osl_pkt_frmnative(osl_pubinfo_t *osh, void *skb, int line, char *file);
#define PKTFRMNATIVE(osh, skb)	osl_pkt_frmnative(((osl_pubinfo_t *)osh), \
				(struct sk_buff*)(skb), __LINE__, __FILE__)
#else /* BCMDBG_PKT */
extern void *osl_pkt_frmnative(osl_pubinfo_t *osh, void *skb);
#define PKTFRMNATIVE(osh, skb)	osl_pkt_frmnative(((osl_pubinfo_t *)osh), \
				(struct sk_buff*)(skb))
#endif /* BCMDBG_PKT */
extern struct sk_buff *osl_pkt_tonative(osl_pubinfo_t *osh, void *pkt);
