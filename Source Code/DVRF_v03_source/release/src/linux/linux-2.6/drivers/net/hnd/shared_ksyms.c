...
extern void defvarslen; EXPORT_SYMBOL(defvarslen);
extern void mfgsromvars; EXPORT_SYMBOL(mfgsromvars);
...
extern void osl_pktalloced_dec; EXPORT_SYMBOL(osl_pktalloced_dec);
extern void osl_pktalloced_inc; EXPORT_SYMBOL(osl_pktalloced_inc);
...
extern void robo_eee_advertise_crtl; EXPORT_SYMBOL(robo_eee_advertise_crtl);
