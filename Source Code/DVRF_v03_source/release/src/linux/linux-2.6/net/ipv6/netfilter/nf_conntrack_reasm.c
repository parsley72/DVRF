...
struct nf_ct_frag6_queue
{
	...
	int			len;
	int			meat;
	/* 2010-12-10 hsubj add 
	 * reply ICMP fragment exceed error message 
	 * (pass IPv6ready test spec.2 item 69, 75 and 76)
	 */
	int			iif;
	ktime_t			stamp;
	unsigned int		csum;
...
/* 2010-12-10 hsubj changed
 * reply ICMP fragment exceed error message
 * (passed IPv6ready test spec.2 item 69, 75 and 76)
 */
// 2011-01-21, marcel,
// Due to below patch cause compiling error when enable CONFIG_NF_CONNTRACK_IPV6
// so... we decide to "#if 0" below codes temporarily!

// enable by Eric 2011-03-21 for ipv6ready Self-test
#if 1 
