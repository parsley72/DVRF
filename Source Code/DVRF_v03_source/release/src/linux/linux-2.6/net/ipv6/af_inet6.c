...
/* 2010-11-16 hsubj copies from linux-2.6.30 to switch IPv6 */
...
static int __init inet6_init(void)
{
	...
	/* 2010-11-16 hsubj copied from linux-2.6.30 to switch IPv6 */
	if (disable_ipv6) {
		printk(KERN_INFO
	 ...
	 * to pass error message of IPv6 address initiation to user space
	 */
	if (ifmsg6_proc_init())
		goto proc_ifmsg6_fail;
#endif
#endif
	ip6_route_init();
	ip6_flowlabel_init();
