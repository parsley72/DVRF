...
#include "../../../linux/linux-2.6/include/linux/netfilter_ipv6/ip6t_REJECT.h"
...
static const struct reject_names reject_table[] = {
	 ...
	 */
	{"icmp6-source-addr-failed", "source address failed",
		IP6T_ICMP6_SOURCE_ADDR_FAILED, "ICMPv6 source address failed"},
	// 2011-09-14, ruby add to parental control (IPv6)
	{"http-redirect", "http-redirect",
		IP6T_HTTP_REDIRECT, "http redirect"}
};
